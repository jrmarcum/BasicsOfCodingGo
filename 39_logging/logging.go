...
// the `log` package for free-form output and the
...
func main() {
	...
	// We can set the prefix on existing loggers (including
	// the standard one) with the `SetPrefix` method.
	...
	// The `slog` package provides _structured_ log output.
