...
> |  **if-else**  | performs a statement 'if' a condition is met and if not, performs a statement 'else if' a\n
>                   condition is met and if not (ie. 'else') performs the default statement                              |
